...
export const javascript: Flashcard[] = [
  ...
  },
  {
    ...
    answer:
      "전역 변수의 문제점은 크게 네 가지입니다.\n\n어디서든 참조하고 변경할 수 있어 의도치 않게 값이 바뀔 수 있고, 생명 주기가 길어 메모리를 오래 차지합니다. 스코프 체인의 종점에 있어 검색 속도가 느리고, 다른 파일의 전역 변수와 이름이 충돌할 수 있습니다.\n\n그래서 즉시 실행 함수, 모듈 패턴, ES6 모듈로 전역 사용을 줄이는 것이 좋습니다.",
  },
  {
    id: 36,
    category: "JavaScript",
