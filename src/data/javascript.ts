...
export const javascript: Flashcard[] = [
  ...
  },
  {
    ...
    answer:
      "변수를 선언한다는 것은 값을 저장할 메모리 공간을 확보하고, 변수 이름과 그 메모리 주소를 연결해 값을 저장할 수 있게 준비하는 것을 말합니다.\n\n선언은 두 단계로 나뉩니다. 선언 단계에서 변수 이름을 자바스크립트 엔진에 등록하고, 초기화 단계에서 메모리 공간을 확보한 뒤 undefined를 할당합니다.\n\nvar는 두 단계가 동시에 진행되지만 let과 const는 분리되어 있어서, 이 차이가 호이스팅 동작 차이와 TDZ의 원인이 됩니다.",
  },
  {
    id: 7,
    category: "JavaScript",
  ...
  },
  {
    ...
    answer:
      "var의 문제점은 크게 세 가지입니다. 블록을 무시하는 함수 레벨 스코프, 중복 선언 허용, 그리고 선언 전 참조가 가능하다는 점입니다.\n\n블록 안에서 선언해도 블록 밖에서 접근할 수 있고, 같은 이름으로 다시 선언해도 에러가 없어 의도치 않게 값이 덮어써집니다.\n호이스팅 때문에 선언 전에 참조해도 에러 대신 undefined가 나와 버그를 알아차리기 어렵습니다.\n\n이런 문제를 해결하려고 ES6에서 let과 const가 도입됐습니다.",
  },
  {
    id: 10,
    category: "JavaScript",
