...
export const javascript: Flashcard[] = [
  ...
  },
  {
    ...
    answer:
      "var는 ES6에서 let과 const가 나오기 전까지 변수를 선언하는 유일한 키워드였습니다.\n\nvar로 선언한 변수는 함수 레벨 스코프를 가져서 블록 안에서 선언해도 함수 전체에서 접근됩니다.\n선언과 초기화가 동시에 진행되므로 호이스팅 단계에서 undefined로 초기화됩니다.\n같은 이름으로 중복 선언해도 에러가 나지 않습니다.\n\n전역에 var로 선언하면 전역 객체의 프로퍼티가 되어 브라우저에서는 window로도 접근됩니다. let과 const는 이렇게 동작하지 않습니다.",
  },
  {
    id: 8,
    category: "JavaScript",
