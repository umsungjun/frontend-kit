...
export const javascript: Flashcard[] = [
  ...
  },
  {
    ...
    answer:
      "컴파일러와 인터프리터는 모두 소스 코드를 기계어로 번역하지만, 전체를 한 번에 번역하느냐 한 줄씩 번역하느냐의 차이가 있습니다.\n\n컴파일러는 소스 코드 전체를 미리 기계어로 번역한 뒤 실행하므로 번역 시간이 필요한 대신 실행 속도가 빠릅니다.\n인터프리터는 코드를 한 줄씩 읽으며 바로 실행하므로 별도 번역 과정 없이 시작할 수 있지만 실행 속도는 상대적으로 느립니다.\n\n자바스크립트는 기본적으로 인터프리터 언어지만, V8 같은 현대 엔진은 JIT 컴파일로 두 방식의 장점을 결합해 성능을 끌어올립니다.",
  },
  {
    id: 3,
    category: "JavaScript",
    ...
    answer:
      "자바스크립트는 동적 타이핑과 프로토타입 기반 객체지향, 일급 함수를 지원하는 멀티 패러다임 언어입니다.\n\n원래 브라우저를 위해 만들어졌지만 지금은 Node.js 등 다양한 환경에서 실행됩니다.\n또한 싱글 스레드로 동작하면서도 이벤트 루프 덕분에 비동기 처리를 효율적으로 해냅니다.",
  },
  {
    id: 4,
    category: "JavaScript",
    question: "변수란 무엇인가요?",
    answer:
      "변수(Variable)란 하나의 값을 저장하기 위해 확보한 메모리 공간, 또는 그 공간을 식별하려고 붙인 이름을 말합니다.\n\n값은 메모리 주소로 직접 접근하는 대신 변수라는 상징적인 이름으로 저장하고 참조합니다.\n그래서 변수에 의미 있는 이름을 붙이면 코드의 가독성과 유지보수성이 크게 좋아집니다.",
  },
  {
    id: 5,
    category: "JavaScript",
    question: "식별자란 무엇인가요?",
    answer:
      "식별자(Identifier)란 변수, 함수, 클래스처럼 어떤 값을 구별해서 부를 수 있는 고유한 이름을 말합니다.\n\n식별자는 값 자체가 아니라 값이 저장된 메모리 주소를 기억하고, 우리는 이 이름으로 메모리의 값에 접근합니다.\n선언하면 자바스크립트 엔진이 그 식별자의 존재를 알게 됩니다.",
  },
  {
    id: 6,
    category: "JavaScript",
