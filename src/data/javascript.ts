...
export const javascript: Flashcard[] = [
  ...
  },
  {
    ...
    answer:
      "데이터 타입은 메모리 공간을 얼마나 확보하고, 읽어온 2진수를 어떻게 해석할지 결정하기 위해 필요합니다.\n\n구체적으로는 세 가지입니다. 값을 저장할 때 확보할 메모리 크기, 값을 참조할 때 한 번에 읽을 메모리 크기, 그리고 읽어온 2진수를 해석하는 기준이 됩니다.\n\n예를 들어 같은 2진수라도 number 타입이면 숫자로, string 타입이면 문자로 해석됩니다.",
  },
  {
    id: 16,
    category: "JavaScript",
