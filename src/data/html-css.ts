...
export const htmlCss: Flashcard[] = [
  ...
  },
  {
    ...
    answer:
      "웹 접근성(Web Accessibility)이란 장애인, 고령자 등 누구나 웹 콘텐츠에 동등하게 접근하고 이용할 수 있도록 보장하는 것을 말합니다.\n\n시각, 청각, 운동 장애 등 다양한 환경의 사용자가 보조 기술(스크린 리더 등)을 통해 웹을 불편 없이 이용할 수 있어야 합니다.\n\n한국에서는 WCAG(웹 콘텐츠 접근성 가이드라인)와 KWCAG(한국형 웹 콘텐츠 접근성 지침)를 기준으로 삼습니다.",
  },
  {
    id: 7,
    category: "HTML/CSS",
  ...
  },
  {
    ...
    answer:
      "시멘틱 태그는 태그 이름만으로 콘텐츠의 의미와 구조를 전달하는 HTML 태그입니다.\n\nheader, nav, main, article, section, aside, footer 등이 대표적입니다.\n\n검색 엔진이 페이지 구조를 더 잘 이해하여 SEO가 향상되고, 스크린 리더 등 보조 기술이 문서를 정확히 해석할 수 있어 접근성이 개선되며, 개발자 간 코드 가독성과 유지보수성도 높아집니다.",
  },
  {
    id: 9,
    category: "HTML/CSS",
  ...
  },
  {
    ...
    answer:
      "이미지 최적화는 압축, 적응형 제공, 지연 로딩 세 가지 축으로 접근합니다.\n\n이미지 압축과 최적화를 통해 파일 크기를 줄이고, WebP 등 차세대 포맷을 사용합니다.\n반응형 이미지를 위해 srcset과 sizes 속성을 활용하여 디바이스에 맞는 크기의 이미지를 제공합니다.\nLazy Loading(loading='lazy')으로 뷰포트에 보이는 이미지만 먼저 로드하고, CDN을 활용하여 이미지 전송 속도를 높이는 것도 효과적입니다.",
  },
  {
    id: 15,
    category: "HTML/CSS",
